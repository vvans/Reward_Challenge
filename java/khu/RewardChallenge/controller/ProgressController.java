...
public class ProgressController {
    ...
    @PostMapping("/upload")
    private String upload(@RequestParam("id") Long id, MultipartFile file,RedirectAttributes redirectAttributes) throws Exception{
        Long challenge_id=connectionRepository.findChallenge_idById(id);
        System.out.print("챌린지 아이디는");
        System.out.println(challenge_id);
        progressService.upload(challenge_id,file);
        redirectAttributes.addAttribute("id", id);
        return "redirect:/progress/my_challenge/{id}";
    }
